...
![](_SharedFolder_fss_introduction_r/img/cartogram.png){.absolute top=0 left=0 width="200%"}
![](_SharedFolder_fss_introduction_r/img/turnout.png){.absolute top=0 left=0 width="200%"}
