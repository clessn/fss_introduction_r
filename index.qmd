...
>>>>>>> 4ade7acf97b5542cd4c304e10b08fc8e3582ae32
...
![](_SharedFolder_fss_introduction_r/img/rstudio.png){.absolute top=0 left=0 width="200%"}

::: {.r-stack}

![](_SharedFolder_fss_introduction_r/img/rstudio_script.png){.fragment .absolute top=0 left=0 width="200%"}

![](_SharedFolder_fss_introduction_r/img/rstudio_console.png){.fragment .absolute top=0 left=0 width="200%"}

![](_SharedFolder_fss_introduction_r/img/rstudio_files.png){.fragment .absolute top=0 left=0 width="200%"}

![](_SharedFolder_fss_introduction_r/img/rstudio_env.png){.fragment .absolute top=0 left=0 width="200%"}
...
Dans cette ligne de code il y a plusieurs éléments :

1. `df` est le nom de l'objet. Dans ce cas-ci, c'est un dataframe.
1. `<-` est l'opérateur d'assignation
1. `read.csv()` est la fonction qui permet de lire le fichier
1. `"chemin/vers/data.csv"` est l'argument qui est passée à la fonction. Ici il s'agit du chemin vers le fichier
...
- Mac: `/`
- Windows: `\` Dans le cas de Windows, il faut s'assurer de changer les `\` pour des `/`
...
![](_SharedFolder_fss_introduction_r/img/df_in_env.png){.absolute top=300 left=0 width="70%"}
